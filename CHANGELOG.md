...
All notable changes to **Network Map** are documented here.
...
- Persistence keys migrated to per-tool namespace `ha-network-map-…` (clean break — old data under `ha-tools-…` is **not** migrated automatically).
